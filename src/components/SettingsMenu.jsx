...
function SettingsMenu() {
  ...
  const [backgroundImage, setBackgroundImage] = useState('/51_upscaled.png');
  const [stopPlaceIdValue, setStopPlaceIdValue] = useState(settings.stopPlaceId);
  ...
  const handleSave = () => {
    ...
    updateSettings({
      numberOfDepartures: value,
      backgroundImg: backgroundImage,
      stopPlaceId: stopPlaceIdValue,
    });
    console.log("Ant:", value, "Bakgrunn:", backgroundImage, "StopPlaceId:", stopPlaceIdValue);
  };
  ...
  const handleTextFieldChange = (event) => {
    // Step 2: Update the state variable when TextField value changes
    setStopPlaceIdValue(event.target.value);
  };
    ...
    <div className="settings-menu">
      ...
      {menuVisible && (
        <div className="menu">
          ...
          <h1 className='headerIns'> Instillinger</h1>
          ...
          <ul>
            ...
            <li>
              <div className='bildeValgDiv'>
                <h2>Bakgrunnsbilde</h2>
                <ImageUploader setBackgroundImage={setBackgroundImage} backgroundImage={backgroundImage} />
              </div>
            </li>
            <li>
              <div className='stoppValgDiv'>
                <h2> Stasjon:</h2>
                <TextField
                  className="inputbox"
                  helperText="Gå til https://entur.no/kart, finn stoppet ditt, og dermed finn id til din stasjon i URLen. Den skal se slik ut: NSR:StopPlace:6009 (eller noen andre tall)"
                  value={stopPlaceIdValue}
