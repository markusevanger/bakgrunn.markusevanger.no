...
function App() {
  ...
  return (
    ...
    <>
      ...
      <div className='mobilCoverDiv'>
        <h1 className='mobilHero'> Heisann! <br /> Dette er ment for landskaps modus</h1>
        <p className='mobilP'> For å demoe kan du rotere f.eks telefonen (men det er ment for en pc skjerm da) </p>
